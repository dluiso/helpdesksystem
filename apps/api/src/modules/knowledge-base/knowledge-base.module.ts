...
import { KnowledgeBaseController, KnowledgeBaseOneNoteOAuthController } from "./knowledge-base.controller";
...
@Module({
  ...
  controllers: [KnowledgeBaseController, KnowledgeBaseOneNoteOAuthController],
